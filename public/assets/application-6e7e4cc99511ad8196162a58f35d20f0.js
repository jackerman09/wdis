...
(function() {
  jQuery(function() {
    var addClickListenersToPlayerPictures, getNumCookieCredits, getNumCredits, pointForPlayer;
...
(function() {
  jQuery(function() {
    var loadinghtml;
    loadinghtml = '<div id="loading-div">' + '<h2>LOADING PLAYER SCORES...</h2>' + '<div id="floatingCirclesG">' + '<div class="f_circleG" id="frotateG_01">' + '</div>' + '<div class="f_circleG" id="frotateG_02">' + '</div>' + '<div class="f_circleG" id="frotateG_03">' + '</div>' + '<div class="f_circleG" id="frotateG_04">' + '</div>' + '<div class="f_circleG" id="frotateG_05">' + '</div>' + '<div class="f_circleG" id="frotateG_06">' + '</div>' + '<div class="f_circleG" id="frotateG_07">' + '</div>' + '<div class="f_circleG" id="frotateG_08">' + '</div>' + '</div>' + '</div>';
    return $('#show-scores-button').bind('ajax:beforeSend', function() {
      return $('#players-table').html(loadinghtml);
    });
  });
